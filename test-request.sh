...
echo "Testing proxy server with different examples..."
echo
...
curl -X POST \
    ...
    "http://localhost:3000/proxy/post"
echo -e "\n"
...
curl -X GET \
    -H "X-Target-URL: https://httpbin.org" \
    "http://localhost:3000/proxy/get?param1=value1&param2=value2"
echo -e "\n"
...
curl -X GET \
    ...
    "http://localhost:3000/proxy/headers"
echo -e "\n"
